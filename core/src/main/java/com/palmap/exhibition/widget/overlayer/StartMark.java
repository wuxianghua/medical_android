 ...
 */
public class StartMark extends ImageView implements ExFloorMark {
    ...
    public StartMark(MapView context,NavigationPointModel navigationPointModel) {
        super(context.getContext());
        this.mapView = context;
        this.navigationPointModel = navigationPointModel;
        setImageResource(R.mipmap.ico_map_marker_s);
    }
