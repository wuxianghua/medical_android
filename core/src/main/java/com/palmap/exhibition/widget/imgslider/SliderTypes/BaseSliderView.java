package com.palmap.exhibition.widget.imgslider.SliderTypes;
...
//    private Picasso mPicasso;
    ...
    protected void bindEventAndShow(final View v,final ImageView targetImageView){
        ...
        RequestManager requestManager = (mReq != null) ? mReq : Glide.with(mContext);
...
//        }
        ...
        drawableTypeRequest.into(new SimpleTarget<GlideBitmapDrawable>() {
            ...
            public void onResourceReady(GlideBitmapDrawable bitmap, GlideAnimation glideAnimation) {
                ...
                targetImageView.setImageDrawable(bitmap);
            }
...
//        drawableTypeRequest.into(targetImageView,new Callback() {
//            @Override
